...
ggplotly(p)
api_create(p, "flow-analysis-MAE-400-0660", sharing = "public")
...
p2 = ggplot(dat2, aes(x = nr_events, y = score, color = method4)) + geom_point() + geom_line() + 
  ...
  theme(legend.title=element_blank())
ggplotly(p2)
api_create(p2, "flow-analysis-RMSE-400-0660", sharing = "public")


pdf(file="results_191117-400-0660.pdf",family="CM Roman",width=12,height=10)
print(p)
dev.off()
embed_fonts("results_191117-400-0660.pdf",outfile="results_191117-400-0660.pdf")
