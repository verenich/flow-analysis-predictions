...
* predictive flow analysis (FA) - single and multiple model options (zero bucketing and prefix-length bucketing, respectively)
* adaptive FA (based on a variable threshold e.g. min N^2 samples in the training set, where N is the number of features )
...
* [Wil](https://www.researchgate.net/publication/220503961_Time_prediction_based_on_process_mining)
* [Andreas Rogge-Solti](https://link.springer.com/chapter/10.1007/978-3-642-45005-1_27).
